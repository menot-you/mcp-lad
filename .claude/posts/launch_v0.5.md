...
Open-source under Apache-2.0. Built with Rust + Swift.
...
Tech: Rust (11K LOC) + Swift (450 LOC). Apache-2.0.
...
Open-source under Apache-2.0. Rust + Swift. 11K LOC.
