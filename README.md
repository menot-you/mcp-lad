...
[![docs.rs](https://docs.rs/nott-mcp-lad/badge.svg)](https://docs.rs/nott-mcp-lad)
[![crates.io](https://img.shields.io/crates/v/nott-mcp-lad.svg)](https://crates.io/crates/nott-mcp-lad)
...
|-----------|-----|--------------------------|
| **Tools** | 29 | 13 |
| **Price** | Free (Apache-2.0) | $19.90 / month |
...
```bash
cargo install nott-mcp-lad  # installs lad, nott-mcp-lad, and lad-relay
```
